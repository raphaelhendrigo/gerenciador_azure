...
<div class="row">
	...
	<div class="" style="float:left; margin-right:10px"><span><small><i title="Data Inicial" class="fa fa-calendar-o"></i></small></span>
		...
		<div class="mobile-busca" style="float:left; margin-right:10px"><span><small><i title="Buscar por Data" class="fa fa-search"></i></small></span></div>
...
<script type="text/javascript">
	...
	function relatorio() {
		...
		var data_final = $('#data-final').val();		
		var status = $('#status').val();
		window.open("rel/emprestimos_class.php?inicio="+data_inicial+"&final="+data_final+"&status="+status+"&devolvido=Não&emprestimos=Empréstimos Ativos");
	}
