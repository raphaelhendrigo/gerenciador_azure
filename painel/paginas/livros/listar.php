...
<small>
	...
	<thead> 
	<tr> 
	<th class="esc">ISBN</th>	
	<th class="">Título</th>	
	<th class="esc">Categoria</th>
	<th class="esc" style="display:none">Editora</th>
...
<td class="esc" style="display:none">{$editora}</td>
...
<big><a href="#" onclick="mostrar('{$codigo}','{$titulo}','{$subtitulo}','{$autor}','{$ano}','{$nome_editora}','{$nome_categoria}','{$foto}','{$nome_local}','{$status}','{$obs}','{$dataF}')" title="Mostrar Dados"><i class="fa fa-info-circle text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function mostrar(codigo, titulo, subtitulo, autor, ano, editora, categoria, foto, local, status, obs, data){
