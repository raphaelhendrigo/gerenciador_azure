...
$query = $pdo->query("SELECT * from $tabela where $status >= '$data_inicial' and $status <= '$data_final' and devolvido = 'Sim' order by data_emprestimo asc");
...
<div align="right" style="margin-top: 10px" class="verde">Total de Devoluções: {$linhas}</div>
HTML;
