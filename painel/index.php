			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-book"></span> Sistema<span class="dashboard_text">Gerenciador Acervo</span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<li><a href="index.php?pagina=leitores"><i class="fa fa-angle-right"></i> Leitores</a></li>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<li><a href="index.php?pagina=livros"><i class="fa fa-angle-right"></i> Livros</a></li>
									...
									<li><a href="index.php?pagina=locais"><i class="fa fa-angle-right"></i> Locais</a></li>

									<li><a href="index.php?pagina=editoras"><i class="fa fa-angle-right"></i> Editoras</a></li>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<li><a href="index.php?pagina=emprestimos"><i class="fa fa-angle-right"></i>Empréstimos Ativos</a></li>

									<li><a href="index.php?pagina=devolucoes"><i class="fa fa-angle-right"></i> Lista de Devoluções</a></li>


									<li><a href="index.php?pagina=devolucoes_hoje"><i class="fa fa-angle-right"></i> Devoluções de Hoje</a></li>


									<li><a href="index.php?pagina=devolucoes_atraso"><i class="fa fa-angle-right"></i> Devoluções em Atraso</a></li>


									<li><a href="index.php?pagina=emprestimos_todos"><i class="fa fa-angle-right"></i>Todos os Empréstimos</a></li>
